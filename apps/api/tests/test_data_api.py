    ...
    resp = client.post(
        ...
        json={
            ...
            "raw": {
                ...
                "events": [
                    {"type": "step_start", "timestamp": 1787496800000, "sessionID": "s1",
                     "part": {"id": "p1", "messageID": "m1", "sessionID": "s1", "type": "step-start"}},
                    {"type": "tool_use", "timestamp": 1787496802000, "sessionID": "s1",
                     "part": {"type": "tool", "tool": "read_file", "callID": "c1",
                              "state": {"status": "completed", "input": {"path": "/a"},
                                        "output": {"ok": True},
                                        "metadata": {"exit": 0, "truncated": False},
                                        "title": "read_file",
                                        "time": {"start": 1787496802000, "end": 1787496807000}},
                              "id": "p2", "sessionID": "s1", "messageID": "m1"}},
                    {"type": "step_finish", "timestamp": 1787496807000, "sessionID": "s1",
